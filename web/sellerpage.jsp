...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
 ...
 <%
                    ...
                    ArrayList<Product> products = DatabaseHelper.searchProductOfAUser(phoneNumber);
        ...
        <div class="pagebody" style="">
            <div class="sideoption" style="width: 20%">
                ...
                <div class="option" style="height: 780px; padding-top: 10px"  >
                    ...
                    <hr>
                    <ul>
                        <a href=""> <li>My Product</li></a>
                        <a href="seller_pending_product.jsp"><li>Product in Review</li></a>
                        <a href="seller_account_view.jsp?phone"><li>My Account</li></a>
            ...
            <div class="maincontent"  style="width: 75%">
                ...
                <center>
                    <h2 style="color: white; margin: 10px">Product in Market</h2>
                    <table border="1px" width="900px" style="background: white">
                        <tr ><td>Product Name</td><td>Category</td><td>Quantity</td><td>Phone Number</td><td>Price</td><td width="200px">Details</td><td>Delete</td></tr>
