<%-- 
    Document   : admin_pending_account
    Created on : Mar 14, 2018, 11:46:38 PM
    Author     : DELL
--%>
    ...
    <body>
        ...
        <div class="pagebody" style="">
            <div class="sideoption" style="width: 20%">
                ...
                <div class="option" style="height: 780px"  >
                    ...
                    <ul>
                       ...
                       <li> <a href="#">Pending Account</a></li>
            ...
            <div class="maincontent"  style="width: 75%">
                <%                   
                    ArrayList<Seller> sellers = DatabaseHelper.getAllPendingSeller();
